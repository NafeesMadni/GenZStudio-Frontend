    ...
    audio_files: [
      {
        source_name: "Drums",
        download_url:
          "https://ujbzjpmepbcrqmrrkbib.supabase.co/storage/v1/object/public/Media-Files/splitter_ai/74e9b461-c886-4e33-8477-ae411099002b/benny-blanco-eastside-lyrics-f-drums.mp3",
      },
      {
        source_name: "Bass",
        download_url:
          "https://ujbzjpmepbcrqmrrkbib.supabase.co/storage/v1/object/public/Media-Files/splitter_ai/74e9b461-c886-4e33-8477-ae411099002b/benny-blanco-eastside-lyrics-f-bass.mp3",
      },
      {
        source_name: "Music",
        download_url:
          "https://ujbzjpmepbcrqmrrkbib.supabase.co/storage/v1/object/public/Media-Files/splitter_ai/74e9b461-c886-4e33-8477-ae411099002b/benny-blanco-eastside-lyrics-f-other.mp3",
      },
      {
        source_name: "Vocal",
        download_url:
          "https://ujbzjpmepbcrqmrrkbib.supabase.co/storage/v1/object/public/Media-Files/splitter_ai/74e9b461-c886-4e33-8477-ae411099002b/benny-blanco-eastside-lyrics-f-vocals.mp3",
      },
    ],
  },
  message: "Sucess",
...
export default function SplitterAI() {
  ...
  useEffect(() => {
    if (audioFiles.length > 0) {
      const initialVolumes = audioFiles.reduce(
        (acc, file) => ({
          ...acc,
          [file.source_name]: 1,
        }),
  ...
  const renderTrackControl = (source: AudioFile, index: number) => (
    <div key={index} className="flex">
      ...
      <div
        className={`lg:flex items-center justify-center px-4 py-2  mr-1 bg-slate-800/30  ${
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: `rgb(34 211 238 / ${
                    individualVolumes[source.source_name] * 10 > i
                      ? "0.8"
                      : "0.1"
                  })`,
                }}
      ...
      <div className="flex-1">
        <div
          ...
          className={`cursor-pointer overflow-hidden px-3 py-2 ${
          ...
          <div className="sticky top-0 z-20  backdrop-blur-md border-b border-sky-500/10">
            <div className="max-w-7xl mx-auto px-2 sm:px-4">
              <div className="flex flex-row items-center justify-between h-14 sm:h-16">
                ...
                {/* Right side controls */}
                <div className="flex items-center gap-2 sm:gap-4">
                  <span className="text-base  md:text-medium text-gray-400 sm:max-w-[100px] md:max-w-[150px] lg:max-w-[200px]">
                    {fileName.length > 15
                      ? fileName.slice(0, 15) + "..."
                      : fileName}
                  </span>
                          ...
                          {downloadProgress[file.source_name] > 0 && (
                            <div className="w-full bg-slate-700/30 rounded-full h-1 mt-2 overflow-hidden">
                              <div
                                ...
                                style={{
                                  width: `${
                                    downloadProgress[file.source_name]
                                  }%`,
                                }}
                              />
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="space-y-1">
              {audioFiles.map((source, index) =>
                renderTrackControl(source, index)
              )}
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-gray-800/15 backdrop-blur-md flex items-center justify-center z-50 p-4 transition-opacity duration-300">
          <div className="text-center p-4 sm:p-6 md:p-8 w-full max-w-xs sm:max-w-sm md:max-w-md bg-slate-900/70  rounded-2xl shadow-2xl border border-cyan-400/20">
            ...
            <p className="text-sm sm:text-base text-gray-400 leading-relaxed py-2 sm:py-3">
              Our AI is processing your audio with precision. Larger files may
              take longer.
              <br />
