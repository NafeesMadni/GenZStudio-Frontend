...
export default function TikTokCaptionGenerator() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/tiktok/caption-generator`, {
        method: "POST",
        headers: {
        ...
        <div className="space-y-6 p-6 bg-gradient-to-b from-sky-950/50 to-slate-900/50 rounded-xl border border-sky-400/30 backdrop-blur-sm">
          ...
          <div className="text-center space-y-3 mb-8">
            ...
            <p className="text-slate-400 text-xs md:text-sm lg:text-base max-w-xl mx-auto">
              Create engaging captions for your TikTok videos
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="e.g., Dance Challenge, Comedy Skit, Tutorial"
